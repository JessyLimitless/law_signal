...
.cover::before {
  ...
  background: radial-gradient(ellipse at 30% 40%, rgba(232,85,109,.15) 0%, transparent 60%),
              radial-gradient(ellipse at 70% 60%, rgba(255,122,142,.10) 0%, transparent 50%);
}
.cover-inner { position:relative; z-index:1; max-width:700px; margin:0 auto; }
.cover-badge {
  ...
  color: var(--accent2);
  background: rgba(255,122,142,.12);
  padding: 6px 18px;
  border-radius: 20px;
  margin-bottom: 28px;
}
...
.cover h1 em { font-style:normal; color: var(--accent2); }
.cover-subtitle {
...
<main class="main">
  ...
  <div class="cover" id="cover">
    <div class="cover-inner">
      ...
      <p class="cover-subtitle">
        기업 지배구조의 소스코드를 읽는 기술<br/>
        법적 리스크를 투자 시그널로 전환하는 25개 섹션의 실전 가이드
      </p>
      <p class="cover-meta">5 Chapters &middot; 25 Sections &middot; 42+ Case Studies</p>
    </div>
  </div>
  ...
  <div class="colophon" id="colophon">
    <div class="colophon-title-area">
      <div class="colophon-book-title">상법 <em>Signal</em></div>
      <div class="colophon-book-sub">기업 지배구조의 소스코드를 읽는 기술</div>
    </div>

    <div class="colophon-divider"></div>

    <div class="colophon-info">
      <div><strong>지은이</strong> DART Insight</div>
      <div><strong>펴낸이</strong> 소셜브레인</div>
      <div><strong>펴낸곳</strong> 소셜브레인</div>
      <div><strong>시리즈</strong> DART Insight Series</div>
      <div><strong>초판 1쇄</strong> 2026년 3월</div>
      <div><strong>등록번호</strong> 251002023000251</div>
      <div><strong>분류</strong> 경제경영 &gt; 투자 &gt; 기업분석</div>
      <div><strong>판형</strong> 전자책 (웹 에디션)</div>
    </div>

    <div class="colophon-price">정가 25,000원</div>

    <div class="colophon-copyright">
      <p>&copy; 2026 소셜브레인. All Rights Reserved.</p>
      <p>이 책의 저작권은 저자에게 있습니다.</p>
      <p>저작권법에 의해 보호를 받는 저작물이므로 무단 전재와 무단 복제를 금합니다.</p>
      <p>이 책 내용의 전부 또는 일부를 이용하려면 반드시 저작권자의 서면 동의를 받아야 합니다.</p>
    </div>

    <div class="colophon-publisher">
      <div class="colophon-publisher-name">소셜브레인</div>
      <div class="colophon-publisher-info">
        본 자료는 법률 교육 및 투자 연구 목적으로 제작되었으며,<br/>
        특정 법률 사안에 대한 법률적 조언이 아닙니다.<br/>
        투자 판단은 독자 본인의 책임하에 이루어져야 합니다.<br/><br/>
        소셜브레인 &middot; 서울특별시 마포구<br/>
        출판사 등록번호 251002023000251 &middot; 등록일자 2023.10.13
      </div>
    </div>
  </div>
  ...
  <footer class="site-footer">
    ...
    <p style="margin-top:6px;">&copy; 2026 DART Insight</p>
  </footer>
</main>
